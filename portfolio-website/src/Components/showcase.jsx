...
function Showcase() {
    return (
        <div className = "flex flex-wrap justify-center">
            ...
            <div className = "my-5 flex justify-evenly w-screen">
                <div className = "outer-shell">
                    <div className = "mid-shell">
                        <div className = " flex flex-wrap p-3 bg-white font-bold content-between h-full">
                ...
                <div className = "outer-shell">
                    <div className = "mid-shell">
                        <div div className = "p-5 bg-white h-full">
            ...
            <div className = "outer-shell w-5/6">
                <div className = "mid-shell w-full">
