    ...
    return (
        <div>
            <div className="flex flex-wrap justify-center content-center items-center">
                <div className="flex flex-wrap justify-center content-center items-center">
                    <img className = "sticky-note m-6 w-1/5" src={img1}/>
                    <img className = "sticky-note m-6 w-1/5" src={img2}/>
                    <img className = "sticky-note m-6 w-1/5" src={img3}/>
                </div>
                <div className = "sticky-note w-2/4 p-5 bg-white mb-6 flex flex-wrap jusify-center">
